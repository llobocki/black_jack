...
// std::array<std::array<Decision, 3>, 2> tab_normal {{{card, card,
// card},{card,card, card}}};
...
std::array<std::array<Decision, 10>, 16> tab_normal{{
    ...
    {card, card, card, card, card, card, card, card, card, card},
    {card, double_card, double_card, double_card, double_card, card, card, card,
     card, card}, // 9
    {double_card, double_card, double_card, double_card, double_card,
     double_card, double_card, double_card, card, card}, // 10
    {double_card, double_card, double_card, double_card, double_card,
     double_card, double_card, double_card, double_card, card},
    ...
    {no_card, no_card, no_card, no_card, no_card, card, card, card, card, card},
    {no_card, no_card, no_card, no_card, no_card, card, card, card, surrender,
     card}, // 15
    {no_card, no_card, no_card, no_card, no_card, card, card, surrender,
     surrender, card}, // 16
    {no_card, no_card, no_card, no_card, no_card, no_card, no_card, no_card,
     no_card, no_card}, // 17
    {no_card, no_card, no_card, no_card, no_card, no_card, no_card, no_card,
     no_card, no_card},
    {no_card, no_card, no_card, no_card, no_card, no_card, no_card, no_card,
...
std::array<std::array<Decision, 10>, 8> tab_soft_ace{{
    {card, card, card, double_card, double_card, card, card, card, card,
     card}, // 13
    {card, card, card, double_card, double_card, card, card, card, card, card},
    {card, card, double_card, double_card, double_card, card, card, card, card,
     card}, //
    {card, card, double_card, double_card, double_card, card, card, card, card,
     card},
    {card, double_card, double_card, double_card, double_card, card, card, card,
     card, card},
    {no_card, double_card, double_card, double_card, double_card, no_card,
     no_card, card, card, card}, // 18
    {no_card, no_card, no_card, no_card, no_card, no_card, no_card, no_card,
     no_card, no_card},
    {no_card, no_card, no_card, no_card, no_card, no_card, no_card, no_card,
     no_card, no_card}, // 20
